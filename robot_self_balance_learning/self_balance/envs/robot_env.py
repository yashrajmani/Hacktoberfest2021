...
class self_balance(gym.Env):
    def __init__(self):
        ...
        self.observation_space = spaces.Box(
            low=np.array([-math.pi, -math.pi, -5]), high=np.array([math.pi, math.pi, 5])
        )
    ...
    def bot_practice_action(self, action):
        ...
        self.tar_vel = [-16.3, -16, -15, -14, -13, -12, -11, 11, 12, 13, 14, 15, 16.3][
            action
        ]
        right_joint = 1
        left_joint = 0
    ...
    def _reset(self):
        ...
        self.botId = p.loadURDF(
            os.path.join(path, "balancebot_simple.urdf"),
            cubeStartPos,
    ...
    def set(self):
        ...
        p.resetBasePositionAndOrientation(
            bodyUniqueId=self.botId, posObj=cubeStartPos, ornObj=cubeStartOrientation
        )
